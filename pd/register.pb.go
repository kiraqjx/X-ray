...
type RegisterResponse struct {
	...
	Data map[uint32]string `protobuf:"bytes,3,rep,name=data,proto3" json:"data,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *RegisterResponse) GetData() map[uint32]string {
	if x != nil {
		return x.Data
	}
	return nil
